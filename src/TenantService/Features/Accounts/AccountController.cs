...
using static TenantService.Features.Accounts.AddOrUpdateAccountCommand;
using static TenantService.Features.Accounts.GetAccountsQuery;
using static TenantService.Features.Accounts.GetAccountByIdQuery;
using static TenantService.Features.Accounts.RemoveAccountCommand;
