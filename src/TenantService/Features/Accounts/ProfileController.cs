...
using static TenantService.Features.Accounts.AddOrUpdateProfileCommand;
using static TenantService.Features.Accounts.GetProfilesQuery;
using static TenantService.Features.Accounts.GetProfileByIdQuery;
using static TenantService.Features.Accounts.RemoveProfileCommand;
