...
const template = require("./tenant-item-embed.component.html");
const styles = require("./tenant-item-embed.component.scss");

export class TenantItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new TenantDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new TenantEdit(this.entity));
    }
...
customElements.define(`ce-tenant-item-embed`,TenantItemEmbedComponent);
