using TenantService.Features.DigitalAssets.UploadHandlers;
...
using static TenantService.Features.DigitalAssets.GetDigitalAssetByUniqueIdQuery;
using static TenantService.Features.DigitalAssets.AzureBlobStorageDigitalAssetCommand;
