...
const template = require("./account-item-embed.component.html");
const styles = require("./account-item-embed.component.scss");

export class AccountItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new AccountDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new AccountEdit(this.entity));
    }
...
customElements.define(`ce-account-item-embed`,AccountItemEmbedComponent);
