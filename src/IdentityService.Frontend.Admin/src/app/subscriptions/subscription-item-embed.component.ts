...
const template = require("./subscription-item-embed.component.html");
const styles = require("./subscription-item-embed.component.scss");

export class SubscriptionItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new SubscriptionDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new SubscriptionEdit(this.entity));
    }
...
customElements.define(`ce-subscription-item-embed`,SubscriptionItemEmbedComponent);
