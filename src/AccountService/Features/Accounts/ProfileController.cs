...
using static AccountService.Features.Accounts.AddOrUpdateProfileCommand;
using static AccountService.Features.Accounts.GetProfilesQuery;
using static AccountService.Features.Accounts.GetProfileByIdQuery;
using static AccountService.Features.Accounts.RemoveProfileCommand;
